...
export default {
  data() {
    return {
      ...
      letter: { state: "全部", abbr: "letter--" },
      letterList: [
        { state: "全部", abbr: "letter--" },
